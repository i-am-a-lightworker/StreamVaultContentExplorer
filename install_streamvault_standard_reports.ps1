# STREAMVAULT Standard Reports installer
# Run from the STREAMVAULT project folder.

$ErrorActionPreference = "Stop"

Write-Host ""
Write-Host "Adding STREAMVAULT Standard Reports..." -ForegroundColor Cyan
...
if (Test-Path ".\streamvault_dashboard.py") {
    ...
    Copy-Item `
        ...
        -Force
    Write-Host "Current dashboard backed up." -ForegroundColor Yellow
}
...
Write-Host ""
Write-Host "Launching STREAMVAULT Standard Reports..." -ForegroundColor Green
