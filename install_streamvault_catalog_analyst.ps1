# STREAMVAULT Conversational Catalog Analyst installer
# Paste this entire script into PowerShell while inside the project folder.

$ErrorActionPreference = "Stop"

Write-Host ""
Write-Host "Installing STREAMVAULT Catalog Analyst..." -ForegroundColor Cyan
...
if (Test-Path ".\streamvault_dashboard.py") {
    ...
    Copy-Item ".\streamvault_dashboard.py" ".\streamvault_dashboard_backup_$stamp.py"
...
Get-Process python,streamlit -ErrorAction SilentlyContinue |
    Where-Object { $_.Path -like "*streamvault*" -or $_.ProcessName -eq "streamlit" } |
    Stop-Process -Force -ErrorAction SilentlyContinue

python -m streamlit cache clear

Write-Host ""
Write-Host "Launching the updated STREAMVAULT app..." -ForegroundColor Green
